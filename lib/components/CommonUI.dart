...
class ColorValue{
  ...
  static const List bgColorList = [0xFF4DAFBE,0xFF7CBC85,0xFFEAAA9D,0xFF7CBC85,0xFF95217A,0xFF3D8962,0xFFE59F54,0xFFB36E28,0xFFDF826F,0xFFEDB379];
  static const List textColorList = [0xFE5775A,0xFFE59578,0xFF3D8962,0xFFBB7FAA,0xFFF9F351,0xFFA42126,0xFF4B70AE,0xFF234881,0xFF3D8962,0xFF7688BD];
...
class CommonUI{
  ...
  static Widget avatarWidget({
    ...
    if (contact != null){
      if (contact.avatar != null){
        ...
        if (contact.sourceProfile != null){
          if (contact.sourceProfile.avatar != null){
      ...
      if (topic.avatarUri != null){
        avatar = File(topic.avatarUri);
      }
      if (topic.name != null){
        name = topic.name;
      }
      if (topic.options != null){
        if (topic.options.backgroundColor != null && topic.options.color != null && topic.options.backgroundColor != null){
    ...
    if (avatar != null && avatar.path.length > 0){
      return CircleAvatar(
        child: Align(
  ...
  static showAlertFunctionMessage(BuildContext context, String contentString,Function call()) {
    showDialog(
        context: context,
        builder: (context) => AlertDialog(
          title: Container(
  ...
  static showChooseAlert(BuildContext context, String title,String content,String sureName,String cancelName,Function call) {
    showDialog(
        context: context,
        builder: (context) => AlertDialog(
          title: Container(
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [Color(0xFFFF7746),Color(0xFFFEB02F)]),
  ...
  static Widget customButton(String buttonName,Function call){
    return Container(
      height: 27,
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [Color(0xFFFF7746),Color(0xFFFEB02F)]),
  ...
  static Widget customGradientButton(String buttonName,Function call, double height) {
    return Container(
      height: height,
      child: FlatButton(
  ...
  static Widget customSureButton(String buttonName,Function call, double height){
    return Container(
      height:height,
      child: FlatButton(
        child: Text("$buttonName",style:TextStyle(
    ...
    return Container(
        ...
        child: Column(
          children: [
            Spacer(),
            Container(
              margin: EdgeInsets.only(left: (width-250)/2,bottom: 20,right: (width-250)/2),
              child: Image.asset("images/icon_nodata.png",width: 250,height: 170),
            ),
            Container(
              child:
              Text("$errorMsg",
