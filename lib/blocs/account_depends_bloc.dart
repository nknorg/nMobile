...
// abstract class AccountDependsBlocdd/* extends Bloc<AccountEvent, DChatAccount>*/ {
...
//
//   Future<ContactSchema> get accountUser => ContactSchema.getContactByAddress(NKNClientCaller.currentChatId);
//
//
//   // bool isAccountValid() {
...
//     assert(user.clientAddress == NKNClientCaller.currentChatId);
//     _accountUser = user;
//   }
//
