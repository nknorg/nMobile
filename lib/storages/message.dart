  ...
  Future<int> deleteByIdContentType(String? msgId, String? contentType) async {
    ...
    return await _queue.add(() async {
          try {
            ...
            // logger.v("$TAG - deleteByIdContentType - empty - msgId:$msgId - contentType:$contentType");
          } catch (e, st) {
            handleError(e, st);
          }
          return 0;
  ...
  Future<int> deleteByTargetIdContentType(String? targetId, String? topic, String? groupId, String? contentType) async {
    ...
    return await _queue.add(() async {
          try {
            ...
            // logger.v("$TAG - deleteByTargetIdContentType - empty - targetId:$targetId - contentType:$contentType");
          } catch (e, st) {
            handleError(e, st);
          }
          return 0;
