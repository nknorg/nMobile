...
class NKNChatRecordScreen extends StatefulWidget {
  @override
  _NKNChatRecordScreenState createState() => _NKNChatRecordScreenState();
}

class _NKNChatRecordScreenState extends State<NKNChatRecordScreen> {
