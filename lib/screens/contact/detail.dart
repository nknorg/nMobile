...
class ContactDetailScreen extends StatefulWidget {
  ...
  ContactDetailScreen({this.contactInfo});
                ...
                children: [
                  Stack(
                    children: <Widget>[
                      GestureDetector(
                        onTap: () {
                          if (currentUser.getShowAvatarPath != null && currentUser.getShowAvatarPath.length > 0) {
                            print('currentUser.avatarFilePath is__' + currentUser.getShowAvatarPath.toString());
                            if (currentUser.getShowAvatarPath != null) {
                              Navigator.push(context, CustomRoute(PhotoPage(arguments: currentUser.getShowAvatarPath)));
                            }
                          } else {
                            updatePic();
                          }
