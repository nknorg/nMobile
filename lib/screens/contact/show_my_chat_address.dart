...
class ShowMyChatAddress extends StatefulWidget {
  static final String routeName = "ShowMyChatAddress";

  final String arguments;

  ShowMyChatAddress({this.arguments});

  @override
  ShowMyChatAddressState createState() => new ShowMyChatAddressState();
}

class ShowMyChatAddressState extends State<ShowMyChatAddress> {
  @override
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: FlatButton(
                ...
                onPressed: () {
                  CopyUtils.copyAction(context, widget.arguments);
                },
                child: Column(
                  children: <Widget>[
                    Row(
