...
class _SendErc20ScreenState extends State<SendErc20Screen> with Tag {
  ...
  _updateFee() {
    _feeController.text = Format.nknFormat(
            (_gasPriceInGwei.gwei.ether * _maxGas),
            decimalDigits: 8)
        .trim();
  ...
  Future<bool> transferAction(password) async {
    try {
      final ethWallet =
          await Ethereum.restoreWalletSaved(schema: wallet, password: password);
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    ...
                                                                    children: <
                                                                        Widget>[
                                                                      Label(
                                                                        _sliderGasPriceMin.toString() +
                                                                            ' ' +
                                                                            NL10ns.of(context).gwei,
                                                                        type: LabelType
                                                                            .bodySmall,
                                                                        color: DefaultTheme
                                                                            .primaryColor,
                                                                  ...
                                                                  Slider(
                                                                    ...
                                                                    min: _sliderGasPriceMin
                                                                        .toDouble(),
                                                                    max: _sliderGasPriceMax
                                                                        .toDouble(),
                                                                  ),
                                                                ],
                                                              ),
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                  ...
                                                                  Slider(
                                                                    ...
                                                                    min: (_ethTrueTokenFalse
                                                                            ? _sliderMaxGasMinEth
                                                                            : _sliderMaxGasMinNkn)
                                                                        .toDouble(),
                                                                    max: _sliderMaxGasMax
                                                                        .toDouble(),
                                                                  ),
                                                                ],
                                                              ),
