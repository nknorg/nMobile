                                                      ...
                                                      Row(
                                                        children: <Widget>[
                                                          ...
                                                          BlocBuilder<WalletBloc, WalletState>(
                                                            builder: (context, state) {
                                                              if (state is WalletLoaded) {
                                                                var w = state.wallets.firstWhere((x) => x == _wallet, orElse: () => null);
                                                                if (w != null) {
                                                                  return Label(
                                                                    nknFormat(w.balance, decimalDigits: 8, symbol: 'NKN'),
                                                                    color: application.theme.fontColor1,
                                                                  );
                                                                }
                                                              }
                                                              return Label('-- NKN', color: application.theme.fontColor1);
                                                            },
                                                          )
                                                        ],
                                                      ),
