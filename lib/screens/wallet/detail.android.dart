...
class WalletDetailAndroidScreen extends BaseStateFulWidget {
  final Map<String, dynamic>? arguments;

  const WalletDetailAndroidScreen({Key? key, this.arguments}) : super(key: key);

  @override
  _WalletDetailAndroidScreenState createState() => _WalletDetailAndroidScreenState();
}

class _WalletDetailAndroidScreenState extends BaseStateFulWidgetState<WalletDetailAndroidScreen> {
