...
import 'package:nmobile/common/message/message.dart';
...
late SyncClient syncClientCommon;
...
void setupLocator() {
  ...
  locator.registerSingleton(SyncClient());
  ...
  syncClientCommon = locator.get<SyncClient>();
